...
func migrate(db *gorm.DB) error {
	if err := db.AutoMigrate(&auth.User{}, &model.DiverProfile{}, &model.DivePlan{}, &model.ExposureSegment{}, &model.DecompressionAssessment{}, &model.RiskAcknowledgment{}, &audit.Event{}); err != nil {
